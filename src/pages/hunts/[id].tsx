          ...
          <div className="text-center lg:text-left w-3/4 md:w-3/5 mx-auto">
            <div className="flex flex-row w-full justify-between align-center text-left items-center">
              ...
              <div className="flex flex-col">
                <div className="badge badge-primary badge-outline">Open</div>
              </div>
            </div>
                  ...
                  <div className="card-body h-2xl flex gap-4">
                    <div>
                      ...
                      <div className="font-normal">
                        Minimum Entry:{" "}
                        <span className="font-bold">{hunt.entry}</span>
                      </div>
                      <div className="font-normal">
                        Total Balance:{" "}
                        <span className="font-bold">{hunt.total}</span>
                      </div>
                      <div className="font-normal">
                        Participants:{" "}
                        <span className="font-bold">{hunt.participants}</span>
                      </div>
                    </div>
