...
function Charity() {
  ...
  <div className="hero-content flex-col-reverse">
    <div className="text-center lg:text-left w-3/4 md:w-3/5">
      <div className='flex flex-row w-full justify-between align-center text-left items-center'><div className="text-5xl font-bold">{hunt.name}</div><div className='flex flex-col'><div className="badge badge-primary badge-outline">{hunt.address}</div></div></div>
