...
function Dashboard() {
  const [hunt, setHunt] = useState([{name: 'Prague Hunt', status: 'Open', bounty: '9', total: '99'}, {name: 'Other Hunt', status: 'Closed', bounty: '5', total: '50'}]);
  const [participants, setParticipants] = useState([{address: "0xE0F05F319B99cF78f5ca4C96197a652B0FC88b5C", deposit: "99", hunt: "first tresure hunt"}, {address: "0xBA73115919e46F82fA990F8067d2905cB6FF3c60", deposit: "13", hunt: "Prague Hack `23"}]);
  ...
  return (
    ...
    <div className='flex flex-row w-full justify-between align-center text-left items-center'>
      <div className="text-6xl font-bold mx-auto my-12 text-gray-300">Manage Your Charity</div>
    </div>
